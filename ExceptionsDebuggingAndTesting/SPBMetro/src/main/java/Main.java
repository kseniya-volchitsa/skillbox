...
public class Main {
   ...
   // private static final String DATA_FILE = "src/main/resources/testmap.json";
    ...
    static void parseConnections(JSONArray connectionsArray) {
    ...
    static void parseLines(JSONArray linesArray) {
